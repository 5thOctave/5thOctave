  ...
  return (
    <main className="p-8 stylish">
      <div className="flex justify-center">
        <div className="">
          <h4 className="text-3xl md:font-bold sm:font-semibold text-center mb-2">Create your 5th Octave Profile!</h4>
          <div className="flex justify-center">
            {data ? (
              <p>
              ...
              <form onSubmit={handleFormSubmit} className="flex flex-col w-40 md:font-semibold text-xl">
                ...
                <select className="my-2 p-2 rounded-lg border-2 border-[#669BBC] md:font-semibold text-xl" name="profileType" onChange={handleChange}>
