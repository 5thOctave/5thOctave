...
const About = () => {
  return (
    <div className="flex flex-col items-center">
      <h1 className="stylish text-4xl md:font-bold sm:font-semibold text-[#669BBC]">What is 5th Octave?</h1>
      ...
      <h2 className="stylish text-3xl md:font-bold sm:font-semibold text-[#669BBC]">How it works</h2>
